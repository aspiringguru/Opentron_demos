...
def fill_rack(left_pipette, tipracks_, master, destination, control_1, control_2, master_offset_col, dest_name, f):
...
def run(protocol):
    ...
    fill_rack(left_pipette, tipracks_, master, destination1, control_1, control_2, 0, "Destination plate 1", f)
    ...
    left_pipette.reset_tipracks()
    fill_rack(left_pipette, tipracks_, master, destination1, control_1, control_2, 12, "Destination plate 3", f)
    protocol.pause("Put a new plate in slot ?? and refill all of the tipracks.")
    #
    print("start dest plate 4")
    left_pipette.reset_tipracks()
    fill_rack(left_pipette, tipracks_, master, destination1, control_1, control_2, 18, "Destination plate 4", f)
    #
    f.close()
